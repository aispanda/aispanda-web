...
| 5. Comments | Signed-in readers participate safely beneath published content. | Comment threads and replies; owner edit/delete; Administrator deletion of any comment; View Only denial; reporting, moderation states, rate limits and notifications. | Role, ownership, abuse, authorization, deletion and moderation scenarios pass before public activation. |
...
- Review database reads/writes, listener breadth and storage before Comments and Community launch.
