...
| EP-10 Comments and moderation | All signed-in roles except View Only can comment and reply; members manage only their own comments while Administrators can delete any. | Planned | `CONTENT_AUTHORING_REQUIREMENTS.md` | Build threads/replies, owner edit/delete, Administrator moderation, View Only denial, reporting, rate limits and role/ownership enforcement tests. |
